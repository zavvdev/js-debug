...
Run `sh v8/bc.sh file.js` to execute file.js with V8 engine using flags listed in _v8/bc.sh_. This
will generate a bytecode for each function that prefixed with bc\_\_\*. Natives syntax allowed.
check `bc.sh` for more exec modes.
